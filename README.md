...
The simulator has a key options for various modalities: 'No Interaction', 'Qurey-Response-Action', 'Query-Response-Update', 'Eavesdrop-Update' and 'Eavesdrop-Buffer-Update'
